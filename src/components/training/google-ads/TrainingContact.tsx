...
export default function TrainingContact({ title, description, ctaText, fields, courseOptions }: Props) {
    ...
    if (success) {
        return (
            <section id="training-contact" className="w-full bg-[#FFF8ED] text-[#171717]">
                <div className="mx-auto w-full max-w-[1500px] px-5 py-[100px] text-center">
                    <h2 className="text-[40px] font-semibold text-[#AF7E2D] italic">
                        Cảm ơn bạn!
                    </h2>
                    <p className="mt-4 text-[18px] text-[#6C6C6C] font-light">
